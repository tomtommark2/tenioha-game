...
> このアプリは、約8000語の英単語を、回答履歴から自動で「未学習・得意・完璧・苦手」に分類します。ユーザーは細かく単語帳を管理しなくても、苦手な単語が復習キューに戻ってくるため、学習と復習が自然につながります。発音表記と音声、例文、学習ログも備えているので、単なる暗記カードではなく、継続しやすい英単語トレーニングとして使えます。
